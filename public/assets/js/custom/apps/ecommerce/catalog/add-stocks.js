"use strict";
var KTModalStocksAdd = (function () {
    var t, e, o, n, r, i;
    return {
        init: function () {
            (i = new bootstrap.Modal(
                document.querySelector("#kt_modal_add_stocks")
            ));
            (r = document.querySelector("#kt_modal_add_stocks_form"));
            (t = r.querySelector("#kt_modal_add_stocks_submit"));
            (e = r.querySelector("#kt_modal_add_stocks_cancel"));
            (o = r.querySelector("#kt_modal_add_stocks_close"));
