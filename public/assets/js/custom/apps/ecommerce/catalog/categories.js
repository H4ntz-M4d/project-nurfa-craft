"use strict";
var KTKategoriProdukList = (function () {
    var t, e;

    const handleDeleteButtons = () => {
        e.querySelectorAll('[data-kt-category-table-filter="delete_row"]').forEach((el) => {
            el.addEventListener("click", function (ev) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: `/kategori/${row.dataset.slug}`, // Pastikan `data-slug` ada di <tr>
                            type: 'DELETE',
                            data: {
    ...
    const handleGroupActions = () => {
        ...
        const deleteSelectedBtn = document.querySelector('[data-kt-category-table-select="delete_selected"]');
    ...
    const updateToolbar = () => {
        ...
        const selectedToolbar = document.querySelector('[data-kt-category-table-toolbar="selected"]');
    ...
    return {
        init: function () {
            ...
            // Search input
            document.querySelector('[data-kt-category-table-filter="search"]')
