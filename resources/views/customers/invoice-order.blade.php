        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card" >
                ...
                <div class="card-body py-20">
                    <!-- begin::Wrapper-->
                    <div class="mw-lg-950px mx-auto w-100" id="invoice-print-area">
                        <!-- begin::Header-->
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            ...
                            <div class="text-sm-end">
                                ...
                                <div class="text-sm-end fw-semibold fs-4 text-muted mt-7">
                                    <div>RT.02, Badan, Panjangrejo, Kabupaten Bantul, Daerah Istimewa Yogyakarta</div>
                                    <div>Kec. Pundong 55771</div>
                                </div>
                                <!--end::Text-->
                            </div>
                        </div>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="#" class="symbol symbol-50px">
                                                                    <img src="{{ asset('storage/'.$detail->produk->gambar) }}" style="width: 50px; height: 50px; object-fit: cover;" />
                                                                </a>
                                                                <!--end::Thumbnail-->
