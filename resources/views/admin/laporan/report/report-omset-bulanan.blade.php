<x-admin.layout>
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-transactions-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Report Omzet" />
                        </div>
                        <!--end::Search-->
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="kt_report_omzet_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center">Omzet Tahunan</th>
    ...
    @push('scripts')
        <script src="{{ asset('assets/js/custom/apps/ecommerce/reports/omset-report/report-omzet.js') }}"></script>
    @endpush
</x-admin.layout>
