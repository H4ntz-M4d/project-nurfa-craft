                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    @foreach ($combinations as $comboIndex => $combo)
                                        <tr>
                                            ...
                                            <td><input type="number" onwheel="this.blur()" name="harga[{{ $comboIndex }}]" class="form-control w-100px w-md-100" min="0" onkeydown="return isNumberKey(event)" placeholder="Rp" /></td>
                                            <td><input type="number" onwheel="this.blur()" name="stok[{{ $comboIndex }}]" class="form-control w-100px w-md-100" min="0" onkeydown="return isNumberKey(event)" value="0" /></td>
                                            <td><input type="text" name="sku[{{ $comboIndex }}]" class="form-control w-100px w-md-100" placeholder="Kode Variasi" /></td>
                                        </tr>
                                    @endforeach
                                </tbody>
