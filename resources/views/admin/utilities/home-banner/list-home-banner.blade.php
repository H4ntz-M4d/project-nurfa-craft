<x-admin.layout>
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-banner-table-filter="search"
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-banner-table-toolbar="base">
                            <!--begin::Add category-->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_banner_home">
                        ...
                        <div class="d-flex justify-content-end align-items-center d-none"
                            ...
                            <div class="fw-bold me-5">
                                <span class="me-2" data-kt-banner-table-select="selected_count"></span>Selected
                            </div>
                            <button type="button" class="btn btn-danger"
                                data-kt-banner-table-select="delete_selected">Delete Selected</button>
                        </div>
                        <!--end::Group actions-->
                    </div>
                    <!--end::Card toolbar-->
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table id="kt_home_banner_table" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
                                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="w-10px pe-2">
                                        <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                            <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                data-kt-check-target="#kt_home_banner_table .form-check-input"
                                                value="1" />
                                        </div>
                                    </th>
                                    <th>Banner</th>
            ...
            <div class="modal-content">
                ...
                <form class="form" method="POST" action="{{ route('home-banner.store') }}"
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_banner_home_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_add_banner_home_header"
                            data-kt-scroll-wrappers="#kt_modal_add_banner_home_scroll" data-kt-scroll-offset="300px">
                            <!--begin::Input group-->
                    ...
                    <div class="modal-footer flex-center">
                        <!--begin::Button-->
                        <button type="reset" id="kt_modal_add_banner_home_cancel"
                            class="btn btn-light me-3">Discard</button>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="kt_modal_add_banner_home_submit" class="btn btn-primary">
    ...
    @push('scripts')
        {{-- ecommerce !!! --}}
        <script src="{{ asset('assets/js/custom/apps/ecommerce/utilities/home-banner/list-home-banner.js') }}"></script>
        <script src="{{ asset('assets/js/custom/apps/ecommerce/utilities/home-banner/add-home-banner.js') }}"></script>
    @endpush
</x-admin.layout>
