<x-admin.layout>
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            data-store-blog-url="{{ route('blog-post.add') }}">
                <div class="card mb-8">
                    <!--begin::Body-->
                                    ...
                                    <div class="mb-17">
                                        <div class="mb-8">
                                            ...
                                            <div class="d-flex justify-content-center image-input image-input-empty image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                ...
                                                <div class="overlay mt-0">
                                                    ...
                                                    bgi-no-repeat bgi-position-center bgi-size-cover" style="background-image: url('assets/media/misc/no-image-landscape.png')"></div>
                                        ...
                                        <div class="p-0">
                                            ...
                                            <div class="mb-8">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <div id="kt_ecommerce_blog_judul" name="judul" class="min-h-200px mb-2"></div>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-8">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <div id="kt_ecommerce_blog_post_description" name="deskripsi" class="min-h-200px mb-2"></div>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-8">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <input id="kt_ecommerce_blog_post_tag" name="tag" class="form-control mb-2" />
                                                <!--end::Editor-->
                                                <!--begin::Description-->
