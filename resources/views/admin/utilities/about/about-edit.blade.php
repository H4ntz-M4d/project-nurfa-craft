    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form id="kt_ecommerce_about_form" class="form d-flex flex-column flex-lg-row" 
                ...
                data-store-about-url="{{ route('about.update', $about->id_about) }}">
                <!--begin::Aside column-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                                ...
                                <div class="image-input-wrapper w-250px h-250px" style="background-image: url({{ asset('storage/'.$about->gambar) }})"></div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="judul" class="form-control mb-2" placeholder="Title" value="{{ $about->judul }}" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div>
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <div id="kt_ecommerce_about_description" name="deskripsi" data-content="{{ $about->deskripsi }}" class="min-h-200px mb-2"></div>
                                <!--end::Editor-->
                                <!--begin::Description-->
