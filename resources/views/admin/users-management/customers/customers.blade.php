<x-layout>
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="index.html" class="text-muted text-hover-primary">Customers</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Master Customers</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form" method="POST" action="{{ route('customers.store') }}"
                            id="kt_modal_add_customer_form" data-kt-redirect="{{ route('customers.index') }}">
                            @csrf
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_add_customer_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Tambah Customers</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid"
                                            placeholder="cont: 0821xxxxxxx" name="no_telp" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
    ...
    @push('scripts')
        {{-- ecommerce !!! --}}
        <script src="{{ asset('assets/js/custom/apps/ecommerce/customers/listing/listing-customers.js') }}"></script>
