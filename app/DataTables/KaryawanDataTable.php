...
class KaryawanDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->select('id_karyawan','id_user','nama','email','no_telp','tgl_lahir','slug');
    }
    ...
    {
        return [
            Column::make('id_karyawan')->title('No'),
            Column::make('id_user')->title('Users'),
            Column::make('nama'),
            Column::make('email'),
            Column::make('no_telp'),
